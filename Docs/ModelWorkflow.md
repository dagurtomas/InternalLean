...
When a generated field is surprising, print provenance diagnostics:
...
The provenance report lists each generated obligation, its source declaration class, generated role,
renderability, and the generated fields mentioned by its rendered type. The lower-level spellings
`#print_lf_model_provenance` and `#print_public_lf_model_provenance` print the same information.
...
The generated interface includes the main structure `T.M` and inherited projection exports. In the
same module as the source theory, generated model-field projections carry editor declaration ranges
back to their source declarations. Strict structural-equivalence structures are generated by a
...
For performance experiments and chunk/export tuning, `scripts/benchmark_large_model_interface.py`
generates synthetic large theories and measures `generate_model_interface` elaboration.
