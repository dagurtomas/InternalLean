...
#check_lf_mirror LeanMirrorSigmaSmoke : Obj := Sigma.fst ⟨o, o⟩
#check_lf_mirror LeanMirrorSigmaSmoke : Obj := Sigma.snd ⟨o, o⟩

namespace LeanMirrorSigmaSmoke

internal_mirror def package : Σ x : Obj, Obj := ⟨o, o⟩
internal_mirror def packageFst : Obj := Sigma.fst package
internal_mirror def packageSnd : Obj := Sigma.snd package
...
#check_lf_mirror LeanMirrorUniverseSmoke : Obj := Sigma.fst ⟨o, witness⟩
#check_lf_mirror LeanMirrorUniverseSmoke : Fiber o := Sigma.snd ⟨o, witness⟩
...
#check_lf_mirror LeanMirrorSigmaEtaPitfall : GoodPack ⟨Sigma.fst p, Sigma.snd p⟩ := good_p
#compare_lf_mirror LeanMirrorSigmaEtaPitfall : GoodPack ⟨Sigma.fst p, Sigma.snd p⟩ := good_p
